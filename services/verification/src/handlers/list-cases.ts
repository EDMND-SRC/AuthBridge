 ...
 */
function maskOmangNumber(omangNumber: string | undefined): string | null {
  if (!omangNumber) return null;
...
export async function handler(
  ...
  try {
    ...
    const status = queryParams.status as VerificationStatus | undefined;
 ...
 */
function mapStatus(status: VerificationStatus): string {
