...
export class BotswanaOmangExtractor {
    country = 'BW';
    documentType = 'national_id';
    requiredFields = ['idNumber', 'surname', 'forenames', 'dateOfBirth', 'dateOfExpiry', 'sex'];
    extract(blocks) {
        const fields = {};
        const confidence = {};
        const warnings = [];
    ...
    extractFrontFields(fullText, blocks, fields, confidence) {
        // Surname
    ...
    extractBackFields(fullText, blocks, fields, confidence, lines) {
        // Nationality
    ...
    extractLocality(lines, fields, confidence) {
...
//# sourceMappingURL=omang-extractor.js.map