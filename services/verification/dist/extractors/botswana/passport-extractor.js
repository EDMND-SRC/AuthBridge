...
export class BotswanaPassportExtractor {
    country = 'BW';
    ...
    extractVisualZoneFields(fullText, blocks, fields, confidence) {
        // Type
    ...
    reconcileMRZWithVisualZone(mrzResult, fields, confidence, warnings) {
...
//# sourceMappingURL=passport-extractor.js.map