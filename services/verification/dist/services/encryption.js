...
export class EncryptionService {
    ...
    constructor(keyId, auditService) {
    ...
    async encryptField(plaintext, retries = 3, resourceId, fieldName) {
        try {
    ...
    async decryptField(ciphertext, retries = 3, resourceId, fieldName) {
        // Check cache first
