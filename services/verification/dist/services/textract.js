...
export class TextractService {
     ...
     */
    async detectDocumentText(bucket, key) {
     ...
     * @returns Textract response with extracted text blocks
     */
    async detectDocumentTextWithRetry(bucket, key, retries = 0) {
        try {
            ...
            const isRetryable = errorMessage.includes('ProvisionedThroughputExceededException') ||
