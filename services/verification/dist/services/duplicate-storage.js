...
export class DuplicateStorageService {
     ...
     */
    async storeDuplicateResults(verificationId, duplicateResult) {
        const now = new Date().toISOString();
        try {
            // Build update expression
            const updateExpression = 'SET duplicateDetection = :duplicateDetection, updatedAt = :updatedAt';
            ...
            if (duplicateResult.requiresManualReview) {
                await this.dynamoDBService.updateItem({
                    ...
                    UpdateExpression: 'SET duplicateDetection = :duplicateDetection, requiresManualReview = :requiresManualReview, flagReason = :flagReason, updatedAt = :updatedAt',
...
//# sourceMappingURL=duplicate-storage.js.map