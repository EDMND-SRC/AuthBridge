/**
 * KYB Voter ID Flow - Modern Fixture Pattern
 *
 * KYB flow differs from KYC:
 * 1. Upload 3 business registration documents
 * 2. Upload ID (voter id) - no confirm step
...
test.describe('KYB Voter ID Flow', () => {
  test('completes business verification with voter ID', async ({
    page,
    openSDKModal,
    takePicture,
  }) => {
